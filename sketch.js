...
function cronometro() {
  ...
  fill(255, 255, 255);
  textSize(25);
  text("Quedan "+round(y)+" años, "+round(mes)+" meses, "+round(dia)+" días, "+round(hor)+" horas, "+round(mi)+" minutos y "+round(sec)+" segundos ",25, h1+50);
  text("para que tu obra finalice. Espere pacientemente...",200, h1+100);
}
